...
| THR-002 | Denial | Auth; brute force ciblée | Compte compromis/indisponible | H / High | Rate limit, verrouillage configurable, alerte | FR-AUTH-014/015 | SEC-AUTH-006 | Medium | BE/TSE |
...
| THR-004 | Information disclosure | Auth; messages/temps révèlent existence | Énumération utilisateurs | H / High | Réponse générique et chemin temporel comparable | FR-AUTH-006/007/013 | SEC-AUTH-001/002/005 | Low-Med | BE |
| THR-005 | Spoofing/Disclosure | Cookie/session volé | Usurpation | M / High | HTTPS, HttpOnly/Secure/SameSite, durée limitée, révocation | FR-AUTH-010/016, NFR-SEC-001 | SEC-SESSION-001 | Medium | BE/DO |
...
| THR-010 | Tampering | CSRF sur logout/admin | Action au nom victime | M / High | SameSite + token CSRF + Origin | FR-AUTH-010, FR-ADMIN-002..004 | SEC-CSRF-001/002 | Low | BE/FE |
...
| THR-012 | Disclosure | Configuration expose secrets | Compromission systèmes | M / Critical | Variables secrètes, moindre privilège, rotation, redaction | NFR-SECRET-001 | SEC-SECRET-001 | Low | DO |
